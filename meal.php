                                ...
                                <div class="card-body">
                                    ...
                                    <form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='POST' enctype="multipart/form-data" data-parsley-validate>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4"  type="text" placeholder="Enter meal name" data-parsley-required="true"  data-parsley-trigger="keyup" data-parsley-pattern="^[a-zA-Z ]+$"name='mealName' value="<?php echo $mealName; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="nationality">Meal Price</label>
                                            <input class="form-control py-4"  type="number" placeholder="Enter meal price" data-parsley-required="true"  data-parsley-trigger="keyup" data-parsley-pattern="^[0-9]+$"name='mealPrice' value="<?php echo $mealPrice; ?>"/>
                                        </div>
                                        ...
                                        <?php
                                            if($_GET['edit']){
                                                echo '<button type="submit" name="update" class="btn btn-primary btn-lg btn-block" required>Save Meal</button>';
                                            }elseif($_GET['view']){
                                                echo '';
                                            }
                                        
                                        ?>
                                        <button type="submit" name="update" class="btn btn-primary btn-lg btn-block" required>Save Meal</button>
                                    </form>
                                </div>
                            </div>
                        </div>
